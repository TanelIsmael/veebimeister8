...
$cmb->add_field(
	array(
		...
		'type'       => 'text',
		'name'       => __( 'Refresh page after Xth questions', 'wp-quiz' ) . '<span class="pro-text">' . esc_html__( 'Pro feature', 'wp-quiz' ) . '</span>',
...
$cmb->add_field(
	array(
		...
		'desc'    => __( '(applies to single page layout)', 'wp-quiz' ),
		'default' => Helper::get_option( 'auto_scroll' ),
		'dep'     => array(
			array( 'wp_quiz_question_layout', 'single' ),
		),
	)
);
