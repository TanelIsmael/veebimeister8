...
function bizplan_get_banner_url(){
	...
	if( !$url ){
		$url = get_theme_file_uri( '/assets/images/placeholder/bizplan-inner-banner-1920-850.jpg' );
	}
...
function bizplan_get_callback_banner_url(){
	...
	if( !$image ){
		$image = get_theme_file_uri( '/assets/images/placeholder/bizplan-callback-1920-650.jpg' );
	}
