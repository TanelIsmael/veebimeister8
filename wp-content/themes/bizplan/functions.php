...
function bizplan_block_editor_styles() {
	// Block styles.
	wp_enqueue_style( 'bizplan-block-editor-style', get_theme_file_uri( '/assets/css/editor-blocks.min.css' ) );
	// Google Font
	wp_enqueue_style( 'bizplan-google-font', 'https://fonts.googleapis.com/css?family=Poppins:300,400,400i,500,600,700,700i', false );
}
add_action( 'enqueue_block_editor_assets', 'bizplan_block_editor_styles' );
