...
if( !empty( $slider_ids ) && is_array( $slider_ids ) && count( $slider_ids ) > 0 && !bizplan_get_option( 'disable_slider' ) ){
?>
		...
		<div class="home-slider owl-carousel">
			<?php
				...
				while ( $query->have_posts() ) : $query->the_post();
					$image = bizplan_get_thumbnail_url( array( 'size' => 'bizplan-1920-750' ) );
			?>
...
if( !bizplan_get_option( 'disable_portfolio' ) ):
	...
	if( !empty( $port_ids ) && is_array( $port_ids ) && count( $port_ids ) > 0 ):
