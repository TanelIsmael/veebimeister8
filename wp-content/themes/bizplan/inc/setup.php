...
function bizplan_setup() {
	...
	register_nav_menus( array(
		...
		'social'  => esc_html__( 'Social Menu', 'bizplan' )
	));
	...
	add_theme_support( 'custom-header', array(
		...
		'height'           => 850,
		'flex-height'      => true,
		'default-image'    => get_parent_theme_file_uri( '/assets/images/placeholder/bizplan-inner-banner-1920-850.jpg' ),
		'wp-head-callback' => 'bizplan_header_style',
	));

	register_default_headers( array(
		'default-image' => array(
			'url'           => '%s/assets/images/placeholder/bizplan-inner-banner-1920-850.jpg',
			'thumbnail_url' => '%s/assets/images/placeholder/bizplan-inner-banner-1920-850.jpg',
			'description'   => esc_html__( 'Default Header Image', 'bizplan' ),
		),
	) );
	...
	*/
	...
	add_theme_support( 'editor-color-palette', array(
       	array(
			'name' => esc_html__( 'Tan', 'bizplan' ),
			'slug' => 'tan',
			'color' => '#E6DBAD',
       	),
       	array(
           	'name' => esc_html__( 'Yellow', 'bizplan' ),
           	'slug' => 'yellow',
           	'color' => '#FDE64B',
       	),
       	array(
           	'name' => esc_html__( 'Orange', 'bizplan' ),
           	'slug' => 'orange',
           	'color' => '#ED7014',
       	),
       	array(
           	'name' => esc_html__( 'Red', 'bizplan' ),
           	'slug' => 'red',
           	'color' => '#D0312D',
       	),
       	array(
           	'name' => esc_html__( 'Pink', 'bizplan' ),
           	'slug' => 'pink',
           	'color' => '#b565a7',
       	),
       	array(
           	'name' => esc_html__( 'Purple', 'bizplan' ),
           	'slug' => 'purple',
           	'color' => '#A32CC4',
       	),
       	array(
           	'name' => esc_html__( 'Blue', 'bizplan' ),
           	'slug' => 'blue',
           	'color' => '#3A43BA',
       	),
       	array(
           	'name' => esc_html__( 'Green', 'bizplan' ),
           	'slug' => 'green',
           	'color' => '#3BB143',
       	),
       	array(
           	'name' => esc_html__( 'Brown', 'bizplan' ),
           	'slug' => 'brown',
           	'color' => '#231709',
       	),
       	array(
           	'name' => esc_html__( 'Grey', 'bizplan' ),
           	'slug' => 'grey',
           	'color' => '#6C626D',
       	),
       	array(
           	'name' => esc_html__( 'Black', 'bizplan' ),
           	'slug' => 'black',
           	'color' => '#000000',
       	),
   	));
	...
	add_theme_support( 'editor-font-sizes', array(
	   	array(
	       	'name' => esc_html__( 'small', 'bizplan' ),
	       	'shortName' => esc_html__( 'S', 'bizplan' ),
	       	'size' => 12,
	       	'slug' => 'small'
	   	),
	   	array(
	       	'name' => esc_html__( 'regular', 'bizplan' ),
	       	'shortName' => esc_html__( 'M', 'bizplan' ),
	       	'size' => 16,
	       	'slug' => 'regular'
	   	),
	   	array(
	       	'name' => esc_html__( 'larger', 'bizplan' ),
	       	'shortName' => esc_html__( 'L', 'bizplan' ),
	       	'size' => 36,
	       	'slug' => 'larger'
	   	),
	   	array(
	       	'name' => esc_html__( 'huge', 'bizplan' ),
	       	'shortName' => esc_html__( 'XL', 'bizplan' ),
	       	'size' => 48,
	       	'slug' => 'huge'
	   	)
	));
	...
	add_image_size( 'bizplan-1920-750', 1920, 750, true );
